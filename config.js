...
module.exports = {
    ...
    OWN3: process.env.OWN3 === undefined ? '94764746599,0' : process.env.OWN3,
    OWN4: process.env.OWN4 === undefined ? '94764746599,0' : process.env.OWN4,
    OWN5: process.env.OWN5 === undefined ? '94764746599,0' : process.env.OWN5,
    BRANCH: 'master',
    HEROKU: {
